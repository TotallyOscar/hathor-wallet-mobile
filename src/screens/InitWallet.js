    ...
    return (
      <SafeAreaView style={{ flex: 1 }}>
        ...
        <View style={this.style.container}>
          <Text style={this.style.title}>{t`Welcome to OscarWallet!`}</Text>
          <View>
            <TextFmt style={this.style.text}>
              {t`This is the official wallet for OscarCoin.`}
       </TextFmt>
            ...
            <Text style={this.style.text}>
              ...
              We recommend you to keep only a small amount of tokens here, such as pocket money.`}
            </Text>
            <Text style={this.style.text}>
              {str2jsx(
                t`For further information, check out our website | **Coming Soon** |.`,
      /* Reminder: Put 'Link:' before the link */
